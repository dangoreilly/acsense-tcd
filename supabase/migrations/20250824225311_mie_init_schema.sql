...
ALTER TABLE ONLY "public"."building_gallery_images"
    ADD CONSTRAINT "building_gallery_images_building_fkey" FOREIGN KEY ("building") REFERENCES "public"."buildings"("canonical") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."floorplans"
    ADD CONSTRAINT "floorplans_building_fkey" FOREIGN KEY ("building") REFERENCES "public"."buildings"("canonical") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."nav_nodes"
    ADD CONSTRAINT "nav_nodes_building_fkey" FOREIGN KEY ("building") REFERENCES "public"."buildings"("canonical") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."rooms"
    ADD CONSTRAINT "rooms_building_fkey" FOREIGN KEY ("building") REFERENCES "public"."buildings"("canonical") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."spaces"
    ADD CONSTRAINT "spaces_building_fkey" FOREIGN KEY ("building") REFERENCES "public"."buildings"("canonical") ON UPDATE CASCADE ON DELETE SET NULL;



ALTER TABLE ONLY "public"."spaces"
    ADD CONSTRAINT "spaces_type_fkey" FOREIGN KEY ("type") REFERENCES "public"."space_styles"("category") ON UPDATE CASCADE;
...
CREATE POLICY "Logs.private" ON "public"."logs" FOR SELECT TO "dashboard_user" USING (true);
