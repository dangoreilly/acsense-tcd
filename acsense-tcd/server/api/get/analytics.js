...
export default defineEventHandler(async (event) => {
    ...
    try {
        ...
        const timeSeriesDataResponse = await fetch('https://plausible.io/api/v1/stats/timeseries?site_id=mie.acsense.ie', {
            headers: {
        ...
        const topPagesDataResponse = await fetch('https://plausible.io/api/v1/stats/breakdown?site_id=mie.acsense.ie&property=event:page&limit=10', {
            headers: {
                Authorization: `Bearer ${plausibleAPIKey}`
            }
        });
