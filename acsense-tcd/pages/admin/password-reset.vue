                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="resetPassword">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="accessToken" type="text" class="form-control mb-3" placeholder="Token" required>

                            <label>Email Address</label>
                            <input v-model="username" type="text" class="form-control mb-3" placeholder="Email" required>
