...
<template>
    ...
    <div class="container m-2">
        <div class="row border border-top border-bottom border-1">

            <div class="col border border-start border-end border-1">
              <em style="display:block"> All</em>
              <input 
              type="checkbox" 
              role="switch"
        ...
        <div v-for="row in rows" class="row border border-bottom border-1">
