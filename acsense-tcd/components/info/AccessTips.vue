...
<div class="card access-tips-card" id="access-tips-box">
    <div class="card-header">
        <h6 class="m-0">
            ...
            <a href="https://forms.office.com/pages/responsepage.aspx?id=WdNmGJlTbkKdewqg_PoOjamL7vEDtPJMn_RJ2taz5-lUQTlTV0JNUFpPQlZaNDNCMTBVUU1HWlVLMC4u&route=shorturl" target="_blank" class="small"> Submit a tip</a>
        </h6>
    </div>
    <div class="card-body">
